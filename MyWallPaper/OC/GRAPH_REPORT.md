# Graph Report - /Users/luowei/projects/My_App/MyWallPaper/MyWallPaper  (2026-05-05)

## Corpus Check
- 132 files · ~99,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 451 nodes · 385 edges · 33 communities detected
...
1. `LWHomeViewController` - 33 edges
2. `UIImage` - 33 edges
3. `UIView` - 22 edges
4. `LWSqliteManager` - 19 edges
5. `LWSettingViewController` - 19 edges
6. `StoreObserver` - 18 edges
7. `UIColor` - 16 edges
8. `LWFavoriteViewController` - 15 edges
9. `LWSavePopoverViewController` - 15 edges
...
## Knowledge Gaps
- **339 isolated node(s):** `-applicationdidFinishLaunchingWithOptions`, `-applicationWillResignActive`, `-applicationDidEnterBackground`, `-applicationWillEnterForeground`, `-applicationDidBecomeActive` (+334 more)
